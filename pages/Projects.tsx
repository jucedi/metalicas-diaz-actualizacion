...
const Projects: React.FC = () => {
  ...
  return (
    <div className="pt-8 pb-20 bg-brand-light min-h-screen">
      <Helmet>
        <title>Portafolio de Proyectos | Metálicas Díaz</title>
        <meta name="description" content="Explora nuestra galería de trabajos terminados. Evidencia de nuestra calidad en proyectos de soldadura, estructuras, cerramientos y Tiny Houses." />
      </Helmet>
