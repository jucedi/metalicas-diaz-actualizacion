...
const Services: React.FC = () => {
  return (
    <div className="pt-8 pb-20">
      <Helmet>
        <title>Servicios | Metálicas Díaz - Soldadura, Aluminio y Estructuras</title>
        <meta name="description" content="Conoce nuestro catálogo de servicios: fabricación de puertas, rejas, estructuras metálicas pesadas, aluminio arquitectónico y construcción de Tiny Houses." />
      </Helmet>
